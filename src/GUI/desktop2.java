...
public class desktop2 extends JFrame implements ActionListener{
	...
	desktop2(){
		...
		img3 = new ImageIcon(getClass().getResource("images/pc3.jpg"));
        pc1 = new JLabel(img3);
        pc1.setSize(228,228);
        pc1.setBounds(260,120,img2.getIconWidth(),200);
		
		
		img4 = new ImageIcon(getClass().getResource("images/pc4.jpg"));
        pc2 = new JLabel(img4);
        pc2.setSize(228,228);
		...
		l1 = new JLabel();
		l1.setText("Category > Desktop");		
		l1.setFont(new Font("Calibri",Font.BOLD,24));
		l1.setBounds(50,110,640,40);
		l1.setForeground(c4);
		
		l3 = new JLabel();
		l3.setText("Intel Core i3-12100 12th Gen Budget Desktop PC");		
		l3.setFont(new Font("Roboto",Font.BOLD,20));
		l3.setBounds(50,160,640,40);
		l3.setForeground(c3);
		
		l4 = new JLabel();
		l4.setText("<html>>Intel Core i3-12100 12th Gen Alder Lake Processor<br>>MSI PRO H610M-E DDR4 mATX Motherboard<br>>Team Elite Plus Red 8GB 3200MHz DDR4 U-DIMM Desktop RAM<br>>Western Digital Green SN350 240GB M.2 NVMe Gen3 SSD<br><br><b>Price: 25,899tk <s>30,000tk<s><b>");		
		l4.setFont(new Font("Calibri",Font.PLAIN,16));
		l4.setBounds(50,80,460,400);
		l4.setForeground(c3);

		l5 = new JLabel();
		l5.setText("Intel 10th Gen Core i3-10100 Custom Desktop PC");
		l5.setFont(new Font("Roboto",Font.BOLD,20));
		l5.setBounds(50,220,460,340);
		l5.setForeground(c3);
		
		l6 = new JLabel();
		l6.setText("<html>>Intel 10th Gen Core i3 10100 Processor<br>>Gigabyte H510M H Intel 10th and 11th Gen Micro ATX Motherboard<br>>Corsair Vengeance LPX 8GB 3200MHz DDR4 Desktop RAM<br>>Team MP33 256GB M.2 PCIe SSD<br><br><b>Price: 28,999tk <s>31,899tk<s><b>");		
	...
	public void actionPerformed(ActionEvent ae)
		{
			if(ae.getSource()==b1)
			{
				...
				String ProductN = "Intel-Core-i3-12100-12th-Gen-Budget-Desktop-PC";
				double Price = 25899.0;
			...
			{
				JOptionPane.showMessageDialog(null,"Successfully added to cart");
				String ProductN = "Intel-10th-Gen-Core-i3-10100-Custom-Desktop-PC";
				double Price = 28999.0;
				CreateOrders co = new CreateOrders(ProductN, Price);
				co.addOrders();
			}
			...
			{
			desktop1 h1 = new desktop1();
			h1.setVisible(true);
			this.setVisible(false);
			}
			else if(ae.getSource()==b5)
			{
			desktop3 h1 = new desktop3();
			h1.setVisible(true);
			this.setVisible(false);
			}
