...
public class laptop1 extends JFrame implements ActionListener{
	...
	laptop1(){
		...
		img3 = new ImageIcon(getClass().getResource("images/pc7.jpg"));
        pc1 = new JLabel(img3);
        pc1.setSize(228,228);
        pc1.setBounds(260,120,img2.getIconWidth(),200);
		
		
		img4 = new ImageIcon(getClass().getResource("images/pc8.jpg"));
        pc2 = new JLabel(img4);
        pc2.setSize(228,228);
		...
		l3 = new JLabel();
		l3.setText("Apple MacBook Air (2022) Apple M2 Chip Gray");		
		l3.setFont(new Font("Roboto",Font.BOLD,20));
		l3.setBounds(50,160,640,40);
		l3.setForeground(c3);
		
		l4 = new JLabel();
		l4.setText("<html>>Processor: Apple M3 chip with 8‑core CPU, 8‑core GPU, 16‑core Neural Engine<br>>RAM: 8GB Unified Memory, Storage: 256GB SSD <br>>Display: 13.6-inch Liquid Retina display (2560x1664) with True Tone<br>>Features: Backlit Magic Keyboard with Touch ID<br><br><b>Price: 152,899tk <s>155,400tk<s><b>");		
		l4.setFont(new Font("Calibri",Font.PLAIN,16));
		l4.setBounds(50,80,460,400);
		l4.setForeground(c3);

		l5 = new JLabel();
		l5.setText("HUAWEI MateBook B3-520 Core i5 11th Gen 15.6 FHD Laptop");
		l5.setFont(new Font("Roboto",Font.BOLD,20));
		l5.setBounds(50,220,460,340);
		l5.setForeground(c3);
		
		l6 = new JLabel();
		l6.setText("<html>>Processor: Intel Core i5-1135G7 (8MB Cache, 2.40 GHz up to 4.20 GHz)<br>>RAM: 8GB LPDDR4X, Storage: 512GB SSD<br>>Display: 15.6FHD (1920x1080) IPS 300 nits<br>>Features: Fingerprint, Pop-up Camera, Type-C<br><br><b>Price: 75,999tk <s>76,899tk<s><b>");		
	...
	public void actionPerformed(ActionEvent ae)
		{
			if(ae.getSource()==b1)
			{
				...
				String ProductN = "Apple-MacBook-Air-(2022)-Apple-M2-Chip-Gray";
				double Price = 155400.0;
			...
			{
				JOptionPane.showMessageDialog(null,"Successfully added to cart");
				String ProductN = "HUAWEI-MateBook-B3-520-Core-i5-11th-Gen-15.6-FHD-Laptop";
				double Price = 76899.0;
				CreateOrders co = new CreateOrders(ProductN, Price);
				co.addOrders();
			}
