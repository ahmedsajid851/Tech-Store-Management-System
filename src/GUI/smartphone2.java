...
public class smartphone2 extends JFrame implements ActionListener{
	...
	smartphone2(){
		...
		img3 = new ImageIcon(getClass().getResource("images/sp3.jpg"));
        pc1 = new JLabel(img3);
        pc1.setSize(228,228);
        pc1.setBounds(260,110,img2.getIconWidth(),200);
		
		
		img4 = new ImageIcon(getClass().getResource("images/sp4.jpg"));
        pc2 = new JLabel(img4);
        pc2.setSize(228,228);
		...
		l3 = new JLabel();
		l3.setText("Xiaomi Redmi 14");		
		l3.setFont(new Font("Roboto",Font.BOLD,20));
		l3.setBounds(50,160,640,40);
		l3.setForeground(c3);
		
		l4 = new JLabel();
		l4.setText("<html>>Powerful Snapdragon 8Gen 3chip for speedy performance<br>>Leica Optics Camera : 200MP<br>>6.36 inch OLED display with a thin bezel design<br>>Longer battery health (100% charges in 31 minutes)<br><br><b>Price: 59,999৳ <s>62,349৳<s><b>");		
		l4.setFont(new Font("Calibri",Font.PLAIN,16));
		l4.setBounds(50,80,460,400);
		l4.setForeground(c3);

		l5 = new JLabel();
		l5.setText("Google Pixel 8 Pro");
		l5.setFont(new Font("Roboto",Font.BOLD,20));
		l5.setBounds(50,220,460,340);
		l5.setForeground(c3);
		
		l6 = new JLabel();
		l6.setText("<html>>Supersmart Ai Feature<br>>Monstrous 200MP camera<br>>Blazing Fast with long battery life<br>>Tough Titanium Design<br><br><b>Price: 128,999৳ <s>130,899৳<s><b>");		
	...
	public void actionPerformed(ActionEvent ae)
		{
			if(ae.getSource()==b1)
			{
				...
				String ProductN = "Xiaomi-Redmi-14";
				double Price = 59999.0;
			...
			{
				JOptionPane.showMessageDialog(null,"Successfully added to cart");
				String ProductN = "Google-Pixel-8-Pro";
				double Price = 118999.0;
				CreateOrders co = new CreateOrders(ProductN, Price);
				co.addOrders();
			}
			...
			{
				smartphone1 h1 = new smartphone1();
				h1.setVisible(true);
				this.setVisible(false);
			}
			else if(ae.getSource()==b5)
			{
				smartphone3 h1 = new smartphone3();
				h1.setVisible(true);
				this.setVisible(false);
			}
