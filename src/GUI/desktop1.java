...
public class desktop1 extends JFrame implements ActionListener{
	...
	desktop1(){
		...
		img3 = new ImageIcon(getClass().getResource("images/pc5.jpg"));
        pc1 = new JLabel(img3);
        pc1.setSize(228,228);
        pc1.setBounds(260,120,img2.getIconWidth(),200);
		
		
		img4 = new ImageIcon(getClass().getResource("images/pc2.jpg"));
        pc2 = new JLabel(img4);
        pc2.setSize(228,228);
		...
		l3 = new JLabel();
		l3.setText("AMD Athlon 3000G Budget Desktop PC");		
		l3.setFont(new Font("Roboto",Font.BOLD,20));
		l3.setBounds(50,160,640,40);
		l3.setForeground(c3);
		
		l4 = new JLabel();
		l4.setText("<html>>AMD Ryzen 5 5600G Processor with Radeon Graphics<br>>MSI B450M-A PRO MAX AMD AM4 Motherboard<br>>Team Elite Plus Red 8GB 3200MHz DDR4 U-DIMM Desktop RAM<br>>Western Digital Green SN350 240GB M.2 NVMe Gen3 SSD<br><br><b>Price: 31,999৳ <s>32,349৳<s><b>");		
		l4.setFont(new Font("Calibri",Font.PLAIN,16));
		l4.setBounds(50,80,460,400);
		l4.setForeground(c3);

		l5 = new JLabel();
		l5.setText("Intel Core i3-12100 12th Gen Desktop PC");
		l5.setFont(new Font("Roboto",Font.BOLD,20));
		l5.setBounds(50,220,460,340);
		l5.setForeground(c3);
		
		l6 = new JLabel();
		l6.setText("<html>>Intel Core i3-12100 12th Gen Alder Lake Processor<br>>MSI PRO H610M-E DDR4 mATX Motherboard<br>>Team Elite Plus Red 8GB 3200MHz DDR4 U-DIMM Desktop RAM<br>>Western Digital Green SN350 240GB M.2 NVMe Gen3 SSD<br><br><b>Price: 28,999৳ <s>30,899৳<s><b>");		
	...
	public void actionPerformed(ActionEvent ae)
		{
			if(ae.getSource()==b1)
			{
				...
				String ProductN = "AMD-Athlon-3000G-Budget-Desktop-PC";
				double Price = 31999.0;
			...
			{
				JOptionPane.showMessageDialog(null,"Successfully added to cart");
				String ProductN = "Intel-Core-i3-12100-12th-Gen-Desktop-PC";
