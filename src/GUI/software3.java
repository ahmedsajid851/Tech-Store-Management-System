...
public class software3 extends JFrame implements ActionListener{
	...
	software3(){
		...
		img3 = new ImageIcon(getClass().getResource("images/sf3.jpg"));
        pc1 = new JLabel(img3);
        pc1.setSize(228,228);
        pc1.setBounds(260,120,img2.getIconWidth(),200);
		
		
		img4 = new ImageIcon(getClass().getResource("images/sf6.jpg"));
        pc2 = new JLabel(img4);
        pc2.setSize(228,228);
		...
		l3 = new JLabel();
		l3.setText("Adobe After Effects CC for Teams");		
		l3.setFont(new Font("Roboto",Font.BOLD,20));
		l3.setBounds(50,160,640,40);
		l3.setForeground(c3);
		
		l4 = new JLabel();
		l4.setText("<html>>Animate logos and characters in 3D, spin graphics, and perform advanced editing tasks like object removal or adding effects effortlessly.<br>>Set text and graphics in motion for engaging content creation.<br><br><b>Price: 66,715 Tk <s>67,715 Tk<s><b>");		
		l4.setFont(new Font("Calibri",Font.PLAIN,16));
		l4.setBounds(50,80,460,400);
		l4.setForeground(c3);

		l5 = new JLabel();
		l5.setText("Adobe Dreamweaver CC for Teams");
		l5.setFont(new Font("Roboto",Font.BOLD,20));
		l5.setBounds(50,220,460,340);
		l5.setForeground(c3);
		
		l6 = new JLabel();
		l6.setText("<html>>Experience fast and flexible coding with streamlined setup processes.<br>>Enjoy seamless Live View editing and multi-monitor support on Windows for enhanced productivity.<br><br><b>Price: 66,715 Tk <s>68,750 Tk<s><b>");		
	...
	public void actionPerformed(ActionEvent ae)
		{
			if(ae.getSource()==b1)
			{
				...
				String ProductN = "Adobe-After-Effects-CC-for-Teams";
			...
			{
				JOptionPane.showMessageDialog(null,"Successfully added to cart");
				String ProductN = "Adobe-Dreamweaver-CC-for-Teams";
				double Price = 66715.0;
				CreateOrders co = new CreateOrders(ProductN, Price);
				co.addOrders();
			}
