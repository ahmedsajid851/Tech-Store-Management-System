...
public class desktop3 extends JFrame implements ActionListener {
    JTextField t1, t2;
    ...
    desktop3() {
        ...
        img4 = new ImageIcon(getClass().getResource("images/pc6.jpg"));
        pc2 = new JLabel(img4);
        pc2.setSize(228, 228);
        ...
        l3 = new JLabel();
        l3.setText("AMD Ryzen 7 5700G GIGABYTE Special Desktop PC");
        l3.setFont(new Font("Roboto", Font.BOLD, 20));
        l3.setBounds(50, 160, 640, 40);
        l3.setForeground(c3);

        l4 = new JLabel();
        l4.setText("<html>>AMD Ryzen 7 5700G Processor with Radeon Graphics <br>>GIGABYTE B450M DS3H V2 AM4 AMD Micro ATX Motherboard<br>>CORSAIR VENGEANCE RGB RS 8GB DDR4 3200MHz RAM<br>>GIGABYTE 256GB NVMe M.2 SSD<br><br><b>Price: 45,899tk <s>47,400tk<s><b>");
        ...
        l5 = new JLabel();
        l5.setText("AMD Ryzen 5 8500G Desktop PC");
        l5.setFont(new Font("Roboto", Font.BOLD, 20));
        l5.setBounds(50, 220, 460, 340);
        l5.setForeground(c3);

        l6 = new JLabel();
        l6.setText("<html>>AMD Ryzen 5 8500G Processor with Radeon Graphics<br>>MSI PRO A620M-E DDR5 AMD mATX Motherboard<br>>TEAM VULCAN Black 8GB DDR5 5200MHz Gaming Desktop RAM<br>>HP EX900 PLUS 256GB M.2 PCIe NVMe Internal SSD<br><br><b>Price: 45,999tk <s>46,899tk<s><b>");
    ...
    public void actionPerformed(ActionEvent ae) {
		...
		if (ae.getSource() == b1) {
			...
			String ProductN = "AMD-Ryzen-7-5700G-GIGABYTE-Special-Desktop-PC";
			double Price = 45899.0;
			CreateOrders co = new CreateOrders(ProductN, Price);
			co.addOrders();
		
        } else if (ae.getSource() == b3) {
			JOptionPane.showMessageDialog(null,"Successfully added to cart");
			String ProductN = "AMD-Ryzen-5-8500G-Desktop-PC";
