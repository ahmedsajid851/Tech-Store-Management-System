...
public class smartphone1 extends JFrame implements ActionListener{
	...
	smartphone1(){
		...
		img3 = new ImageIcon(getClass().getResource("images/sp1.jpg"));
        pc1 = new JLabel(img3);
        pc1.setSize(228,228);
        pc1.setBounds(260,100,img2.getIconWidth(),200);
		
		
		img4 = new ImageIcon(getClass().getResource("images/sp2.jpg"));
        pc2 = new JLabel(img4);
        pc2.setSize(228,228);
		...
		l3 = new JLabel();
		l3.setText("Apple 15 Pro Max");		
		l3.setFont(new Font("Roboto",Font.BOLD,20));
		l3.setBounds(50,160,640,40);
		l3.setForeground(c3);
		
		l4 = new JLabel();
		l4.setText("<html>>Biggest,Brightest display yet (6.67inch OLED)<br>>Super fast A17 Bionic chipset<br>>Camera: 48MP main lens,Improved zoom<br>>Longer battery health<br><br><b>Price: 149,999৳ <s>152,349৳<s><b>");		
		l4.setFont(new Font("Calibri",Font.PLAIN,16));
		l4.setBounds(50,80,460,400);
		l4.setForeground(c3);

		l5 = new JLabel();
		l5.setText("Samsung Galaxy S24 Ultra");
	...
	public void actionPerformed(ActionEvent ae)
		{
			if(ae.getSource()==b1)
			{
				...
				String ProductN = "Apple-15-Pro-Max";
				double Price = 149000.0;
			...
			{
				JOptionPane.showMessageDialog(null,"Successfully added to cart");
				String ProductN = "Samsung-Galaxy-S24-Ultra";
				double Price = 128000.0;
				CreateOrders co = new CreateOrders(ProductN, Price);
				co.addOrders();
			}
