...
public class laptop2 extends JFrame implements ActionListener{
	...
	laptop2(){
		...
		img3 = new ImageIcon(getClass().getResource("images/pc9.jpg"));
        pc1 = new JLabel(img3);
        pc1.setSize(228,228);
        pc1.setBounds(260,120,img2.getIconWidth(),200);
		
		
		img4 = new ImageIcon(getClass().getResource("images/pc10.jpg"));
        pc2 = new JLabel(img4);
        pc2.setSize(228,228);
		...
		l3 = new JLabel();
		l3.setText("Lenovo IdeaPad Slim 1i Intel Celeron N4020 14 FHD Laptop");		
		l3.setFont(new Font("Roboto",Font.BOLD,20));
		l3.setBounds(50,160,640,40);
		l3.setForeground(c3);
		
		l4 = new JLabel();
		l4.setText("<html>>Processor: Intel Celeron N4020 (4M Cache, 1.10 GHz up to 2.80 GHz)<br>>RAM: 8GB Unified Memory, Storage: 256GB SSD <br>>Display: 13.6-inch Liquid Retina display (2560x1664) with True Tone<br>>Features: Backlit Magic Keyboard with Touch ID<br><br><b>Price: 52,899tk <s>55,400tk<s><b>");		
		l4.setFont(new Font("Calibri",Font.PLAIN,16));
		l4.setBounds(50,80,460,400);
		l4.setForeground(c3);

		l5 = new JLabel();
		l5.setText("HP 250 G8 Core i3 11th Gen 256GB SSD 15.6 FHD Laptop");
		l5.setFont(new Font("Roboto",Font.BOLD,20));
		l5.setBounds(50,220,460,340);
		l5.setForeground(c3);
		
		l6 = new JLabel();
		l6.setText("<html>>Processor: Intel Core i5-1135G7 (8MB Cache, 2.40 GHz up to 4.20 GHz)<br>>RAM: 8GB LPDDR4X, Storage: 512GB SSD<br>>Display: 15.6FHD (1920x1080) IPS 300 nits<br>>Features: Fingerprint, Pop-up Camera, Type-C<br><br><b>Price: 55,999tk <s>56,899tk<s><b>");		
	...
	public void actionPerformed(ActionEvent ae)
		{
			if(ae.getSource()==b1)
			{
				...
				String ProductN = "Lenovo-IdeaPad-Slim-1i-Intel-Celeron-N4020-14-FHD-Laptop";
				double Price = 55999.0;
			...
			{
				JOptionPane.showMessageDialog(null,"Successfully added to cart");
				String ProductN = "HP-250-G8-Core-i3-11th-Gen-256GB-SSD-15.6-FHD-Laptop";
				double Price = 52598.0;
				CreateOrders co = new CreateOrders(ProductN, Price);
				co.addOrders();
			}
			...
			{
				laptop1 h1 = new laptop1();
				h1.setVisible(true);
				this.setVisible(false);
			}
			else if(ae.getSource()==b5)
			{
				laptop3 h1 = new laptop3();
				h1.setVisible(true);
				this.setVisible(false);
			}
