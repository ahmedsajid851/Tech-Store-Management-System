...
public class software2 extends JFrame implements ActionListener{
	...
	software2(){
		...
		img3 = new ImageIcon(getClass().getResource("images/sf1.jpg"));
        pc1 = new JLabel(img3);
        pc1.setSize(228,228);
        pc1.setBounds(260,120,img2.getIconWidth(),200);
		
		
		img4 = new ImageIcon(getClass().getResource("images/sf4.jpg"));
        pc2 = new JLabel(img4);
        pc2.setSize(228,228);
		...
		l3 = new JLabel();
		l3.setText("Adobe Acrobat Standard DC for Teams");		
		l3.setFont(new Font("Roboto",Font.BOLD,20));
		l3.setBounds(50,160,640,40);
		l3.setForeground(c3);
		
		l4 = new JLabel();
		l4.setText("<html>>The most trusted PDF solution enables users to create, edit, sign, and track documents from anywhere, anytime.<br>>It seamlessly converts PDFs to Microsoft Office 365 formats, facilitating e-signatures and real-time response tracking.<br><br><b>Price: 25,470 Tk <s>26,470 Tk<s><b>");		
		l4.setFont(new Font("Calibri",Font.PLAIN,16));
		l4.setBounds(50,80,460,400);
		l4.setForeground(c3);

		l5 = new JLabel();
		l5.setText("Adobe Fresco CC for Teams");
		l5.setFont(new Font("Roboto",Font.BOLD,20));
		l5.setBounds(50,220,460,340);
		l5.setForeground(c3);
		
		l6 = new JLabel();
		l6.setText("<html>>Effortlessly blend vector and raster brushes on one canvas, while cloud documents ensure seamless synchronization.<br>>Easily isolate layer parts and animate drawings with Motion tools for streamlined creativity.<br><br><b>Price: 36,695 Tk <s>37,695 Tk<s><b>");		
	...
	public void actionPerformed(ActionEvent ae)
		{
			if(ae.getSource()==b1)
			{
				...
				String ProductN = "Adobe-Acrobat-Standard-DC-for-Teams";
				double Price = 25476.0;
			...
			{
				JOptionPane.showMessageDialog(null,"Successfully added to cart");
				String ProductN = "Adobe-Fresco-CC-for-Teams";
				double Price = 36695.0;
				CreateOrders co = new CreateOrders(ProductN, Price);
				co.addOrders();
			}
